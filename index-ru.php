      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="#nearest-container">Ближайшая отправка</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#our-services">Чем мы лучше</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#stages-work">Этапы работы</a>
            </li>
            <li class="nav-item">
          ...
          <form class="d-flex" role="search">
            ...
            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Скачать приложение</button>
          </form>
        </div>
      </div>
    </nav>
